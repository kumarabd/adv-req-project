...
import com.devcometvisionapp.storage.ImageCacheIndex;
...
public class ImageDiskCache {
  ...
  public File getImage(URL imageUrl) {
    ...
    try {
      ...
      com.devcometvisionapp.FileUtil.copyContents(in, out);
      out.flush();
    } catch (Exception e) {
      // Download failed, log failure, and clear return value
      Log.e(StartNavigation.LOG_TAG, "Failed to download: " + imageUrl, e);
      cacheFile = null;
    } finally {
  ...
  private File toFile(String cacheValue) {
    File offlineImageCacheDir = com.devcometvisionapp.FileUtil.getCacheDirectory("offlineImages");
