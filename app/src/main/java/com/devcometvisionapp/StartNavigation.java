...
import com.devcometvisionapp.MapDisplay.MapImageTooLargeException;
import com.devcometvisionapp.kml.GroundOverlay;
import com.devcometvisionapp.kml.KmlFeature;
import com.devcometvisionapp.kml.KmlFinder;
...
public class StartNavigation extends AppCompatActivity {
    ...
    private void displayUserMessage(final String message) {
        Runnable displayTask = () -> Toast.makeText(StartNavigation.this, message, Toast.LENGTH_LONG).show();
    ...
    private void displaySafetyReminder(Bundle savedState) {
        ...
        safetyReminder.setOnDismissListener(dialog -> {
            ...
            if (reminder.wasButtonPressed() && !reminder.getShowAgainRequested()) {
                PreferenceStore.instance(StartNavigation.this).setReminderRequested(false);
            }
            safetyReminder = null;
        });
        safetyReminder.show();
