...
/**
 * Implementation of mapping of default string resource IDs to corresponding Polish IDs.
 *
 * @author Marko Teittinen
 */
class Pl_Polish extends Linguist.LanguageStore {

  Pl_Polish() {
    resourceIdMap.put(R.string.about_custom_maps, R.string.pl_about_custom_maps);
    resourceIdMap.put(R.string.accuracy, R.string.pl_accuracy);
    resourceIdMap.put(R.string.adjust_tiepoint, R.string.pl_adjust_tiepoint);
    resourceIdMap.put(R.string.all_maps, R.string.pl_all_maps);
    resourceIdMap.put(R.string.altitude, R.string.pl_altitude);
    ...
    resourceIdMap.put(R.string.button_add_point, R.string.pl_button_add_point);
    resourceIdMap.put(R.string.button_cancel, R.string.pl_button_cancel);
    resourceIdMap.put(R.string.button_close, R.string.pl_button_close);
    resourceIdMap.put(R.string.button_ok, R.string.pl_button_ok);
    resourceIdMap.put(R.string.button_preview, R.string.pl_button_preview);
    resourceIdMap.put(R.string.button_save, R.string.pl_button_save);
    resourceIdMap.put(R.string.create_map, R.string.pl_create_map);
    resourceIdMap.put(R.string.create_map_help, R.string.pl_create_map_help);
    resourceIdMap.put(R.string.create_map_help_link, R.string.pl_create_map_help_link);
    resourceIdMap.put(R.string.create_map_name, R.string.pl_create_map_name);
    resourceIdMap.put(R.string.credits_text, R.string.pl_credits_text);
    resourceIdMap.put(R.string.delete_map, R.string.pl_delete_map);
    resourceIdMap.put(R.string.delete_map_dialog, R.string.pl_delete_map_dialog);
    resourceIdMap.put(R.string.delete_map_dialog_negative, R.string.pl_delete_map_dialog_negative);
    resourceIdMap.put(R.string.delete_map_dialog_positive, R.string.pl_delete_map_dialog_positive);
    resourceIdMap.put(R.string.delete_map_dialog_title, R.string.pl_delete_map_dialog_title);
    resourceIdMap.put(R.string.delete_tiepoint, R.string.pl_delete_tiepoint);
    resourceIdMap.put(R.string.deleting_map_failed, R.string.pl_deleting_map_failed);
    ...
    resourceIdMap.put(R.string.download_no_datadir, R.string.pl_download_no_datadir);
    resourceIdMap.put(R.string.download_progress_label, R.string.pl_download_progress_label);
    resourceIdMap.put(R.string.download_starting, R.string.pl_download_starting);
    resourceIdMap.put(R.string.download_successful, R.string.pl_download_successful);
    resourceIdMap.put(R.string.download_title_label, R.string.pl_download_title_label);
    resourceIdMap.put(R.string.downloads, R.string.pl_downloads);
    resourceIdMap.put(R.string.edit_prefs_name, R.string.pl_edit_prefs_name);
    resourceIdMap.put(R.string.editor_description, R.string.pl_editor_description);
    resourceIdMap.put(R.string.editor_help, R.string.pl_editor_help);
    resourceIdMap.put(R.string.editor_image_load_failed, R.string.pl_editor_image_load_failed);
    resourceIdMap.put(R.string.editor_map_name, R.string.pl_editor_map_name);
    resourceIdMap.put(R.string.editor_map_save_failed, R.string.pl_editor_map_save_failed);
...
//    resourceIdMap.put(R.string.export_all_maps, R.string.pl_export_all_maps);
    ...
    resourceIdMap.put(R.string.geo_point_rotate, R.string.pl_geo_point_rotate);
    resourceIdMap.put(R.string.geo_point_scale, R.string.pl_geo_point_scale);
    resourceIdMap.put(R.string.geo_point_transparency, R.string.pl_geo_point_transparency);
    resourceIdMap.put(R.string.google_code, R.string.pl_google_code);
    resourceIdMap.put(R.string.gps_not_available, R.string.pl_gps_not_available);
    resourceIdMap.put(R.string.gps_outside_map, R.string.pl_gps_outside_map);
    resourceIdMap.put(R.string.heading, R.string.pl_heading);
    resourceIdMap.put(R.string.heading_hide, R.string.pl_heading_hide);
    resourceIdMap.put(R.string.heading_show, R.string.pl_heading_show);
    resourceIdMap.put(R.string.heading_title, R.string.pl_heading_title);
    resourceIdMap.put(R.string.help_menu_title, R.string.pl_help_menu_title);
    resourceIdMap.put(R.string.help_redisplay, R.string.pl_help_redisplay);
    resourceIdMap.put(R.string.image_point_help, R.string.pl_image_point_help);
    resourceIdMap.put(R.string.image_point_no_image, R.string.pl_image_point_no_image);
    resourceIdMap.put(R.string.image_point_select_for_matching, R.string.pl_image_point_select_for_matching);
    resourceIdMap.put(R.string.language_default, R.string.pl_language_default);
    resourceIdMap.put(R.string.language_selected_format, R.string.pl_language_selected_format);
    resourceIdMap.put(R.string.language_title, R.string.pl_language_title);
    resourceIdMap.put(R.string.latitude, R.string.pl_latitude);
    resourceIdMap.put(R.string.local_maps, R.string.pl_local_maps);
    resourceIdMap.put(R.string.location_details, R.string.pl_location_details);
    ...
    resourceIdMap.put(R.string.metric_use_english, R.string.pl_metric_use_english);
    resourceIdMap.put(R.string.metric_use_metric, R.string.pl_metric_use_metric);
    resourceIdMap.put(R.string.modify_map, R.string.pl_modify_map);
    resourceIdMap.put(R.string.my_location, R.string.pl_my_location);
    resourceIdMap.put(R.string.nearby_maps, R.string.pl_nearby_maps);
    resourceIdMap.put(R.string.no_data_available, R.string.pl_no_data_available);
    resourceIdMap.put(R.string.no_map_sharing_apps, R.string.pl_no_map_sharing_apps);
    resourceIdMap.put(R.string.no_maps_found_on_sd, R.string.pl_no_maps_found_on_sd);
    ...
    resourceIdMap.put(R.string.select_image_invalid, R.string.pl_select_image_invalid);
    resourceIdMap.put(R.string.select_image_processing, R.string.pl_select_image_processing);
    ...
    resourceIdMap.put(R.string.share_chooser_title, R.string.pl_share_chooser_title);
    resourceIdMap.put(R.string.share_map, R.string.pl_share_map);
    resourceIdMap.put(R.string.share_map_failed, R.string.pl_share_map_failed);
