...
import static com.devcometvisionapp.StartNavigation.LOG_TAG;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      pdfRendererFragment = (PdfRendererFragment) getSupportFragmentManager()
          .findFragmentByTag(StartNavigation.PDF_RENDERER_FRAGMENT_TAG);
    ...
    if (pdfRendererFragment == null) {
      ...
      getSupportFragmentManager().beginTransaction()
          .add(pdfRendererFragment, StartNavigation.PDF_RENDERER_FRAGMENT_TAG)
          .commit();
    }
  }
