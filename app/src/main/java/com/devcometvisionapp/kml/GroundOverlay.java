...
public class GroundOverlay extends KmlFeature {
  ...
  /**
   * Original tiepoints associated with tiepoint aligned maps. Ignored by Google Earth.
   */
  public static class Tiepoint implements Serializable {
    ...
    public Tiepoint(LatLng geoPoint, Point imagePoint) {
    ...
    public void setGeoPoint(LatLng geoPoint) {
      if (geoPoint == null) {
        throw new IllegalArgumentException("Null locations are not allowed in Tiepoint");
      }
      this.geoPoint = geoPoint;
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException {
      ...
      int x = in.readInt();
      int y = in.readInt();
      geoPoint = new LatLng(latitude, longitude);
