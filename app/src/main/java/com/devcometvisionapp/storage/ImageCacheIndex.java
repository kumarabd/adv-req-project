...
public class ImageCacheIndex {
  private static final String INDEX_NAME = "com.devcometvisionapp.cache";
  ...
  public synchronized String removeKey(String url) {
    ...
    if (value != null) {
      cacheIndex.edit().remove(url).apply();
    }
    return value;
  }
  ...
  private synchronized String generateValue(String key) {
    ...
    Set<String> valuesInUse = new HashSet<>();
    ...
    cacheIndex.edit().putString(key, valueStr).apply();
    return valueStr;
  }
}
