 ...
 */
package com.devcometvisionapp.storage;
...
import com.devcometvisionapp.MapApiKeys;
import com.devcometvisionapp.UnitsManager;
...
public class PreferenceStore {
  ...
  public static final String SHARED_PREFS_NAME = "com.devcometvisionapp.prefs";
  ...
  public String getVersion() {
    ...
    try {
      ...
      Log.w(StartNavigation.LOG_TAG, "Failed to find version info for app", e);
    }
    return version;
  }
  ...
  public UnitsManager.DistanceUnits getDistanceUnits() {
    ...
    try {
      ...
      if (!undefined.equals(unitsName)) {
        ...
        Log.w(StartNavigation.LOG_TAG, "Invalid distance units preference: " + unitsName);
      }
    }
