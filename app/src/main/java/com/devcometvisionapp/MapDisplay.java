...
import com.devcometvisionapp.kml.IconStyle;
...
public abstract class MapDisplay extends View {
  ...
  protected List<Placemark> mapMarkers = new ArrayList<>();
  protected com.devcometvisionapp.DisplayState displayState;
  ...
  protected void drawMapMarkers(Canvas canvas, com.devcometvisionapp.DisplayState displayState) {
  ...
  private void drawPlacemark(Canvas canvas, Placemark marker) {
    ...
    LatLng geo = marker.getPoint();
    coordinates[0] = (float) geo.longitude;
    coordinates[1] = (float) geo.latitude;
   ...
   * @param displayState
   */
  public void setDisplayState(com.devcometvisionapp.DisplayState displayState) {
